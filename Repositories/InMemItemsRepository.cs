...
namespace Catalog.Repositories
{
    public class InMemItemRepository : IItemsRepository
    {
        private readonly List<Item> items = new()
        {
            ...
            new Item { Id = Guid.NewGuid(), Name = "Irons Sword", Price = 50, CreatedDate = DateTimeOffset.UtcNow }
        };
        public IEnumerable<Item> GetItems() //IEnumerable basic interace for returning a collection of items 
        {
            return items;
        }
